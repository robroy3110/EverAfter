...
fun initializeSongs() {
    ...
    val song5 = createSong("Closer", "Nine Inch Nails", "The Downward Spiral", "", "gs://everafter-382e1.appspot.com/Songs/Closer.mp3", "The_Downward_Spiral__by_Nine_Inch_Nails.png")
    val song10 = createSong("Cigarette", "OFFONOFF Feat. Tablo", "boy.", "", "gs://everafter-382e1.appspot.com/Songs/OFFONOFF_-_Cigarette_Feat._Tablo___MISO.mp3","offonoff.jpg")


    val song6 = createSong("Heart Shaped Box", "Nirvana", "In Utero (Deluxe Edition)", "", "gs://everafter-382e1.appspot.com/Songs/Nirvana_-_Heart_Shaped_Box.mp3", "InUtero.jpeg")

    val song7 = createSong("I WANNA BE YOUR SLAVE", "Maneskin", "Teatro d'ira - Vol.I", "", "gs://everafter-382e1.appspot.com/Songs/Maneskin_-_I_WANNA_BE_YOUR_SLAVE_Audio.mp3","Måneskin_Teatro_d'ira_Vol._I.png")

    val song13 = createSong("Jeremy", "Pearl Jam", "Ten", "", "gs://everafter-382e1.appspot.com/Songs/Pearl_Jam_-_Jeremy_Video.mp3", "Pearl_Jam_-_Ten.jpg")

    val song11 = createSong("Need You Now", "Lady Antebellum", "Need You Now", "", "gs://everafter-382e1.appspot.com/Songs/01.Need_You_Now-_Lady_Antebellum_Audio.mp3", "Need_You_Now.jpg")

    val song9 = createSong("Roslyn", "Bon Iver, St. Vincent ", "The Twilight Saga (Original Motion Picture Soundtrack)", "", "gs://everafter-382e1.appspot.com/Songs/8._Roslyn_-_Bon_Iver___St._Vincent.mp3", "bon_iver.jpeg")

    val song14 = createSong("Since I Don't Have You", "The Skyliners", "Since I Don't Have You", "", "gs://everafter-382e1.appspot.com/Songs/The_Skyliners_-_Since_I_Dont_Have_You.mp3", "the_skyliners.jpg")

    val song1 = createSong("Valerie", "Amy Winehouse", "Back To Black", "", "gs://everafter-382e1.appspot.com/Songs/Amy_Winehouse_-_Valerie.mp3","Capa_de_Back_to_Black.jpg")

    val song8 = createSong("Undisclosed Desires", "Muse", "The Resistance", "", "gs://everafter-382e1.appspot.com/Songs/Muse_-_Undisclosed_Desires.mp3","muse.jpg")
